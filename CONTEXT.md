...
- **Nach Steigerung**: Vorschlag annehmen → der **erste Satz** geht auf das neue Gewicht und die **Zielwiederholungen**; **Folgesätze behalten ihre Wiederholungen** und wandern um denselben Betrag mit (Back-off-Muster 60/55/50 wird zu 62,5/57,5/52,5, statt eingeebnet zu werden). Live ggf. weniger Wdh / spätere Sätze runterdrehen, über Einheiten wieder hocharbeiten. Die **Vorschlags-Serie wird zurückgesetzt**: gezählt werden nur Einheiten auf dem aktuellen Arbeitsgewicht, nach Steigerung *oder* Deload beginnt sie neu. → Aufgelöst.
